 ...
 const sampleTurfs = [
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      {/* Navbar */}
  <nav className="bg-[#2e8b57] text-white py-4 shadow-md">
  <div className="container mx-auto flex justify-between items-center px-6">
    ...
    <div className="space-x-6 flex items-center">
      ...
      <button 
        className="border border-white px-4 py-1 rounded-md hover:bg-white hover:text-[#2e8b57] transition font-semibold"
      >
        Logout
      </button>
      ...
      <div className="text-center py-8">
        ...
        <div className="flex justify-center items-center space-x-2">
          ...
          />
          <button className="bg-[#2e8b57] text-white px-5 py-2 rounded-md hover:bg-green-700 transition">
            Search
          </button>
        </div>
      </div>
          ...
          filteredTurfs.map((turf) => (
            ...
            >
              ...
              <div className="p-4 space-y-1">
                ...
                <button
                  className="mt-2 w-full bg-[#2e8b57] text-white py-2 rounded-md hover:bg-green-700 transition"
                  onClick={(e) => {
                    e.stopPropagation();
      ...
      {selectedTurf && (
        ...
        >
          ...
          >
            ...
            <button
              className="mt-4 w-full bg-[#2e8b57] text-white py-2 rounded-md hover:bg-green-700 transition"
